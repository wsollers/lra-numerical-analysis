...
Canonical overlay: capabilities/overlays/lra-numerical-analysis.md
...
Repository: `lra-numerical-analysis`
Canonical repo overlay: `capabilities/overlays/lra-numerical-analysis.md`
Canonical route resolver:
`python <governance-root>/scripts/govpy.py capabilities/resolve.py --repo lra-numerical-analysis --task "<user task>" --root <repo-root>`
