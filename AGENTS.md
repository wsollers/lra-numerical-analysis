...
Canonical overlay: docs/governance/repo-overlays/lra-numerical-analysis.md
...
Canonical repo overlay: `docs/governance/repo-overlays/lra-numerical-analysis.md`
Canonical route resolver:
`python <governance-root>/capabilities/resolve.py --repo lra-numerical-analysis --task "<user task>" --root <repo-root>`
